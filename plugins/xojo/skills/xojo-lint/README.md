...
The `XOJO_LINT` default at the top of the hook finds `xojo_lint.py` where Claude Code installs the plugin. For any other install, Codex included, export `XOJO_LINT` as the real path of the script or edit the default in the hook.
