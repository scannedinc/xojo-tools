...
| [`xojo-migrate`](plugins/xojo/skills/xojo-migrate/) | Converts Xojo source code from API 1 to API 2 with vetted, confidence-tiered conversion rules, and knows which changes a rename does not fix. |
